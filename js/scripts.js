$(document).ready(function() {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Reeti and Anshul's Wedding",

      // Event start date
      start: new Date("DEC 7, 2021 17:00"),
      ...
      end: new Date("DEC 7, 2021 23:00"),

      // Event Address
      address: "Diamond galaxy party lawn, Kanpur",

      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Mr. Dheeraj at +91 9792066660."
    }
  });
...
// Google map
function initMap() {
  var location = { lat: 26.4143179, lng: 80.2674007 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 26.4143179, lng: 80.2674007 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false
